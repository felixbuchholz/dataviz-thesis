...
export default {
  ...
  computed: {
    ...
    uigChanged() {
      ...
      if (this.uigPerAdult != 0 && this.onlyUIG[0].checked == true) {
        uigChanged = true;
      }
      return uigChanged;
    },
  ...
  methods: {
    ...
    calculateUIGPerBin(i) {
      ...
      if (this.onlyUIG[0].checked) {
        UIGPositionInBin.val = uigMinusTaxPerAvgHoushold;
        UIGPositionInBin.valueBefore = uigMinusTaxPerAvgHoushold;
        UIGPositionInBin.valUpLim = uigMinusTaxPerAvgHoushold;
        UIGPositionInBin.valLowLim = uigMinusTaxPerAvgHoushold;
        UIGPositionInBin.total = uigMinusTaxPerAvgHoushold;
      }
    },
